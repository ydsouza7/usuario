...
import com.yandaniel.usuario.infrastructure.entity.Telefone;
...
import com.yandaniel.usuario.infrastructure.repository.EnderecoRepository;
import com.yandaniel.usuario.infrastructure.repository.TelefoneRepository;
...
public class UsuarioService {
    ...
    public TelefoneDTO cadastraTelefone (String token, TelefoneDTO dto){
        ...
        return usuarioConverter.paraTelefoneDTO(
                telefoneRepository.save(telefone)  //esse método é igual ao da linha 121 e 122 porém de forma simplificada
        );
